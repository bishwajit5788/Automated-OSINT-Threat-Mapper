...
class ReconRequest(BaseModel):
    domain: str = Field(..., min_length=3, max_length=253, description="Public DNS hostname to assess. Active scanning is authorized-use only.")
